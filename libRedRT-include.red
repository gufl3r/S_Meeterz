...
red: context [
    ...
    #import [libRedRT-file stdcall [
            ...
            f_math: "f_math" [] 
            f_charset: "f_charset" [] 
            f_ctx||181~on-parse-event: "f_ctx||181~on-parse-event" [octx [pointer! [integer!]]] 
            ...
            f_dt: "f_dt" [] 
            f_clock: "f_clock" [] 
            f_ctx||263~interpreted?: "f_ctx||263~interpreted?" [octx [pointer! [integer!]]] 
            f_ctx||266~on-change*: "f_ctx||266~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||273~on-change*: "f_ctx||273~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||273~on-deep-change*: "f_ctx||273~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||279~on-change*: "f_ctx||279~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||277~on-change*: "f_ctx||277~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||277~on-deep-change*: "f_ctx||277~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||307~tracer: "f_ctx||307~tracer" [octx [pointer! [integer!]]] 
            f_ctx||325~on-change*: "f_ctx||325~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||328~on-change*: "f_ctx||328~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||328~on-deep-change*: "f_ctx||328~on-deep-change*" [octx [pointer! [integer!]]] 
            f_reactor: "f_reactor" [] 
            f_deep-reactor: "f_deep-reactor" [] 
            f_ctx||334~add-relation: "f_ctx||334~add-relation" [octx [pointer! [integer!]]] 
            f_ctx||334~identify-sources: "f_ctx||334~identify-sources" [octx [pointer! [integer!]]] 
            f_ctx||334~eval: "f_ctx||334~eval" [octx [pointer! [integer!]]] 
            f_ctx||334~eval-reaction: "f_ctx||334~eval-reaction" [octx [pointer! [integer!]]] 
            f_ctx||334~pending?: "f_ctx||334~pending?" [octx [pointer! [integer!]]] 
            f_ctx||334~check: "f_ctx||334~check" [octx [pointer! [integer!]]] 
            ...
            f_ctx||351~alpha-num+: "f_ctx||351~alpha-num+" [octx [pointer! [integer!]]] 
            f_ctx||351~parse-url: "f_ctx||351~parse-url" [octx [pointer! [integer!]]] 
            f_decode-url: "f_decode-url" [octx [pointer! [integer!]]] 
            f_encode-url: "f_encode-url" [octx [pointer! [integer!]]] 
            f_ctx||357~do-quit: "f_ctx||357~do-quit" [octx [pointer! [integer!]]] 
            f_ctx||357~throw-error: "f_ctx||357~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||357~syntax-error: "f_ctx||357~syntax-error" [octx [pointer! [integer!]]] 
            f_ctx||357~do-safe: "f_ctx||357~do-safe" [octx [pointer! [integer!]]] 
            f_ctx||357~do-code: "f_ctx||357~do-code" [octx [pointer! [integer!]]] 
            f_ctx||357~rebind-all: "f_ctx||357~rebind-all" [octx [pointer! [integer!]]] 
            f_ctx||357~count-args: "f_ctx||357~count-args" [octx [pointer! [integer!]]] 
            f_ctx||357~arg-mode?: "f_ctx||357~arg-mode?" [octx [pointer! [integer!]]] 
            f_ctx||357~func-arity?: "f_ctx||357~func-arity?" [octx [pointer! [integer!]]] 
            f_ctx||357~value-path?: "f_ctx||357~value-path?" [octx [pointer! [integer!]]] 
            f_ctx||357~fetch-next: "f_ctx||357~fetch-next" [octx [pointer! [integer!]]] 
            f_ctx||357~eval: "f_ctx||357~eval" [octx [pointer! [integer!]]] 
            f_ctx||357~do-macro: "f_ctx||357~do-macro" [octx [pointer! [integer!]]] 
            f_ctx||357~register-macro: "f_ctx||357~register-macro" [octx [pointer! [integer!]]] 
            f_ctx||357~reset: "f_ctx||357~reset" [octx [pointer! [integer!]]] 
            f_ctx||357~expand: "f_ctx||357~expand" [octx [pointer! [integer!]]] 
            f_expand-directives: "f_expand-directives" [octx [pointer! [integer!]]] 
            f_ctx||376~calc-max: "f_ctx||376~calc-max" [octx [pointer! [integer!]]] 
            f_ctx||376~show-context: "f_ctx||376~show-context" [octx [pointer! [integer!]]] 
            f_ctx||376~show-parents: "f_ctx||376~show-parents" [octx [pointer! [integer!]]] 
            f_ctx||376~show-stack: "f_ctx||376~show-stack" [octx [pointer! [integer!]]] 
            f_ctx||376~show-watching: "f_ctx||376~show-watching" [octx [pointer! [integer!]]] 
            f_ctx||376~do-command: "f_ctx||376~do-command" [octx [pointer! [integer!]]] 
            f_ctx||376~debugger: "f_ctx||376~debugger" [octx [pointer! [integer!]]] 
            f_ctx||393~mold-part: "f_ctx||393~mold-part" [octx [pointer! [integer!]]] 
            f_ctx||393~dumper: "f_ctx||393~dumper" [octx [pointer! [integer!]]] 
            f_ctx||393~push: "f_ctx||393~push" [octx [pointer! [integer!]]] 
            f_ctx||393~drop: "f_ctx||393~drop" [octx [pointer! [integer!]]] 
            f_ctx||393~pop: "f_ctx||393~pop" [octx [pointer! [integer!]]] 
            f_ctx||393~top-of: "f_ctx||393~top-of" [octx [pointer! [integer!]]] 
            f_ctx||393~step: "f_ctx||393~step" [octx [pointer! [integer!]]] 
            f_ctx||402~put: "f_ctx||402~put" [octx [pointer! [integer!]]] 
            f_ctx||402~get: "f_ctx||402~get" [octx [pointer! [integer!]]] 
            f_ctx||406~save-level: "f_ctx||406~save-level" [octx [pointer! [integer!]]] 
            f_ctx||406~unroll-level: "f_ctx||406~unroll-level" [octx [pointer! [integer!]]] 
            f_ctx||406~reset: "f_ctx||406~reset" [octx [pointer! [integer!]]] 
            f_ctx||406~collector: "f_ctx||406~collector" [octx [pointer! [integer!]]] 
            f_ctx||393~guided-trace: "f_ctx||393~guided-trace" [octx [pointer! [integer!]]] 
            f_ctx||413~inspect: "f_ctx||413~inspect" [octx [pointer! [integer!]]] 
            f_ctx||376~profiler: "f_ctx||376~profiler" [octx [pointer! [integer!]]] 
            f_ctx||376~do-handler: "f_ctx||376~do-handler" [octx [pointer! [integer!]]] 
            ...
            f_ctx||432~tail-idx?: "f_ctx||432~tail-idx?" [octx [pointer! [integer!]]] 
            f_ctx||432~push-color: "f_ctx||432~push-color" [octx [pointer! [integer!]]] 
            f_ctx||432~pop-color: "f_ctx||432~pop-color" [octx [pointer! [integer!]]] 
            f_ctx||432~close-colors: "f_ctx||432~close-colors" [octx [pointer! [integer!]]] 
            f_ctx||432~push: "f_ctx||432~push" [octx [pointer! [integer!]]] 
            f_ctx||432~pop: "f_ctx||432~pop" [octx [pointer! [integer!]]] 
            f_ctx||432~pop-all: "f_ctx||432~pop-all" [octx [pointer! [integer!]]] 
            f_ctx||432~optimize: "f_ctx||432~optimize" [octx [pointer! [integer!]]] 
            f_rtd-layout: "f_rtd-layout" [octx [pointer! [integer!]]] 
            f_ctx||430~line-height?: "f_ctx||430~line-height?" [octx [pointer! [integer!]]] 
            f_ctx||430~line-count?: "f_ctx||430~line-count?" [octx [pointer! [integer!]]] 
            f_metrics?: "f_metrics?" [] 
            ...
            f_ctx||452~on-deep-change*: "f_ctx||452~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||456~on-change*: "f_ctx||456~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||456~on-deep-change*: "f_ctx||456~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||460~on-change*: "f_ctx||460~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||463~on-change*: "f_ctx||463~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||466~capture-events: "f_ctx||466~capture-events" [octx [pointer! [integer!]]] 
            f_ctx||466~awake: "f_ctx||466~awake" [octx [pointer! [integer!]]] 
            f_ctx||474~init: "f_ctx||474~init" [octx [pointer! [integer!]]] 
            f_draw: "f_draw" [] 
            ...
            f_ctx||478~opt-as-integer: "f_ctx||478~opt-as-integer" [octx [pointer! [integer!]]] 
            ...
            f_ctx||478~add-bounds: "f_ctx||478~add-bounds" [octx [pointer! [integer!]]] 
            ...
            f_alert: "f_alert" [] 
            f_ctx||528~encode: "f_ctx||528~encode" [octx [pointer! [integer!]]] 
            f_ctx||528~decode: "f_ctx||528~decode" [octx [pointer! [integer!]]] 
            f_ctx||535~to-csv-line: "f_ctx||535~to-csv-line" [octx [pointer! [integer!]]] 
            f_ctx||535~escape-value: "f_ctx||535~escape-value" [octx [pointer! [integer!]]] 
            f_ctx||535~next-column-name: "f_ctx||535~next-column-name" [octx [pointer! [integer!]]] 
            f_ctx||535~make-header: "f_ctx||535~make-header" [octx [pointer! [integer!]]] 
            f_ctx||535~get-columns: "f_ctx||535~get-columns" [octx [pointer! [integer!]]] 
            f_ctx||535~encode-map: "f_ctx||535~encode-map" [octx [pointer! [integer!]]] 
            f_ctx||535~encode-maps: "f_ctx||535~encode-maps" [octx [pointer! [integer!]]] 
            f_ctx||535~encode-flat: "f_ctx||535~encode-flat" [octx [pointer! [integer!]]] 
            f_ctx||535~encode-blocks: "f_ctx||535~encode-blocks" [octx [pointer! [integer!]]] 
            f_load-csv: "f_load-csv" [octx [pointer! [integer!]]] 
            f_to-csv: "f_to-csv" [octx [pointer! [integer!]]] 
            f_ctx||548~decode-unicode-char: "f_ctx||548~decode-unicode-char" [octx [pointer! [integer!]]] 
            f_ctx||548~push: "f_ctx||548~push" [octx [pointer! [integer!]]] 
            f_ctx||548~pop: "f_ctx||548~pop" [octx [pointer! [integer!]]] 
            f_ctx||548~emit: "f_ctx||548~emit" [octx [pointer! [integer!]]] 
            f_load-json: "f_load-json" [octx [pointer! [integer!]]] 
            f_ctx||555~init-state: "f_ctx||555~init-state" [octx [pointer! [integer!]]] 
            f_ctx||555~emit-indent: "f_ctx||555~emit-indent" [octx [pointer! [integer!]]] 
            f_ctx||555~emit-key-value: "f_ctx||555~emit-key-value" [octx [pointer! [integer!]]] 
            f_ctx||555~red-to-json-value: "f_ctx||555~red-to-json-value" [octx [pointer! [integer!]]] 
            f_to-json: "f_to-json" [octx [pointer! [integer!]]] 
            f_ctx||562~encode: "f_ctx||562~encode" [octx [pointer! [integer!]]] 
            f_ctx||562~decode: "f_ctx||562~decode" [octx [pointer! [integer!]]] 
            f_keep: "f_keep" [] 
            ...
            ctx||310~encode: "ctx||310~encode" [img [red-image!] where [cell!]] 
            ctx||310~decode: "ctx||310~decode" [data [cell!]] 
            ctx||313~encode: "ctx||313~encode" [img [red-image!] where [cell!]] 
            ctx||313~decode: "ctx||313~decode" [data [cell!]] 
            ctx||316~encode: "ctx||316~encode" [img [red-image!] where [cell!]] 
            ctx||316~decode: "ctx||316~decode" [data [cell!]] 
            ctx||319~encode: "ctx||319~encode" [img [red-image!] where [cell!]] 
            ctx||319~decode: "ctx||319~decode" [data [cell!]] 
            ctx||322~encode: "ctx||322~encode" [data [cell!] where [cell!]] 
            ctx||322~decode: "ctx||322~decode" [payload [cell!]] 
            event?: "event?" [value [cell!] return: [logic!]] 
            find-flag?: "find-flag?" [facet [cell!] flag [red-word!]] 
            ctx||474~make-null-handle: "ctx||474~make-null-handle" [] 
            ctx||474~get-screen-size: "ctx||474~get-screen-size" [id [integer!]] 
            ctx||474~size-text: "ctx||474~size-text" [face [red-object!] value [cell!]] 
            ctx||474~on-change-facet: "ctx||474~on-change-facet" [owner [red-object!] word [red-word!] value [cell!] action [red-word!] new [cell!] index [integer!] part [integer!]] 
            ctx||474~update-font: "ctx||474~update-font" [font [red-object!] flags [integer!]] 
            ctx||474~update-para: "ctx||474~update-para" [face [red-object!] flags [integer!]] 
            ctx||474~destroy-view: "ctx||474~destroy-view" [face [red-object!] empty? [logic!]] 
            ctx||474~update-view: "ctx||474~update-view" [face [red-object!]] 
            ctx||474~refresh-window: "ctx||474~refresh-window" [h [red-handle!]] 
            ctx||474~redraw: "ctx||474~redraw" [face [red-object!]] 
            ctx||474~show-window: "ctx||474~show-window" [id [red-handle!]] 
            ctx||474~make-view: "ctx||474~make-view" [face [red-object!] parent [red-handle!]] 
            ctx||474~draw-image: "ctx||474~draw-image" [image [red-image!] cmds [red-block!]] 
            ctx||474~draw-face: "ctx||474~draw-face" [face [red-object!] cmds [red-block!]] 
            ctx||474~do-event-loop: "ctx||474~do-event-loop" [no-wait? [logic!]] 
            ctx||474~exit-event-loop: "ctx||474~exit-event-loop" [] 
            ctx||474~request-font: "ctx||474~request-font" [font [red-object!] selected [cell!] mono? [logic!]] 
            ctx||474~request-file: "ctx||474~request-file" [title [cell!] name [cell!] filter [cell!] save? [logic!] multi? [logic!]] 
            ctx||474~request-dir: "ctx||474~request-dir" [title [cell!] dir [cell!] filter [cell!] keep? [logic!] multi? [logic!]] 
            ctx||474~text-box-metrics: "ctx||474~text-box-metrics" [box [red-object!] arg0 [cell!] type [integer!]] 
            ctx||474~update-scroller: "ctx||474~update-scroller" [scroller [red-object!] flags [integer!]] 
            ctx||474~set-dark-mode: "ctx||474~set-dark-mode" [face [red-object!] dark? [logic!]] 
            ctx||474~support-dark-mode?: "ctx||474~support-dark-mode?" [return: [logic!]] 
            ...
            ctx||548~unescape: "ctx||548~unescape" [str [red-string!] return: [red-string!]] 
            f_time-it: "f_dt" [] 
            f_single?: "f_last?" [] 
            f_keys-of: "f_words-of" [] 
            f_object: "f_context" [] 
            f_halt: "f_quit" [] 
            f_ctx||393~emit: "red/natives/print*" [check? [logic!]] 
